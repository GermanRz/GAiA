            ...
            <div class="card-header border-0 d-flex justify-content-between align-items-center">
                ...
                <div class="card-tools ml-auto">
                    ...
                    <button type="button" class="btn btn-success" data-toggle="modal"
                        data-target="#modal-agregarUsuario">Agregar Usuario</button>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="tblUsuarios" class="table table-dark table-bordered table-striped dt-responsive nowrap"
                    style="width:100%">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="input-group col-md-7">
                                ...
                                <input type="text" class="form-control" name="nuevoDocumento" id="nuevoDocumento"
                                    placeholder="Numero identificación" required>
                            </div>
                    ...
                    <div class="input-group mb-3 date">
                        ...
                        <input type="date" class="form-control" name="nuevoFechaNacimiento"
